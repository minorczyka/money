...
package firebase {
  ...
  trait Thenable[T] extends js.Object {
    def `catch`(onReject: js.Function1[FirebaseError, Any] = ???): js.Dynamic = js.native

    def then(onResolve: js.Function1[T, Any] = ???, onReject: js.Function1[FirebaseError, Any] = ???): firebase.Thenable[js.Any] = js.native
  }
